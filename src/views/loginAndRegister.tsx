                    ...
                    <n-tab-pane name="signin" tab="登录">
                        <n-form
                            ...
                            <n-form-item-row label="密码" path="password">
                                <n-input type="password" v-model:value={loginFormValue.value.password} placeholder="请输入密码" />
                            </n-form-item-row>
                        </n-form>
                    ...
                    <n-tab-pane name="signup" tab="注册">
                        <n-form
                            ...
                            <n-form-item-row label="用户名" path="name">
                                <n-input v-model:value={registerFormValue.value.name} placeholder="请输入用户名" />
                            </n-form-item-row>
                            <n-form-item-row label="手机号" path="phone">
                                <n-input v-model:value={registerFormValue.value.phone} placeholder="请输入手机号" />
                            </n-form-item-row>
                            <n-form-item-row label="密码" path="password">
                                <n-input type="password" v-model:value={registerFormValue.value.password} placeholder="请输入密码" />
                            </n-form-item-row>
                            <n-form-item-row label="确认密码" path="password_confirm">
                                <n-input type="password" v-model:value={registerFormValue.value.password_confirm} placeholder="请输入确认密码" />
                            </n-form-item-row>
                        </n-form>
